...
# TODO функция должна принимать параметры которые не будут пересекаться с глобальными по имени
def enter_number():
    print("Введите первую точку")
    entr_x1 = float(input('X: '))
    entr_y1 = float(input('Y: '))
    print("\nВведите вторую точку")
    entr_x2 = float(input('X: '))
    entr_y2 = float(input('Y: '))
    return entr_x1, entr_x2, entr_y1, entr_y2


x1, x2, y1, y2 = enter_number()
x_diff = x1 - x2
y_diff = y1 - y2
